...
function Maps() {
  ...
  const handleOpenPanoramicViewWindow = () => {
    if (ipcRenderer) {
      ipcRenderer.send('open-panoramic-view-window', currentPreviewMap);
    } else {
      console.log("Panoramic view window functionality is not available in web mode.");
    }
  };
  ...
  return (
    <div className="maps-container">
      <div className="maps-buttons-container">
        ...
        <button onClick={handleOpenPanoramicViewWindow} className="open-panoramic-view-window-btn">Abrir Vista Panorámica</button>
