  ...
  return (
    <div className="database-container">
      ...
      <div className="database-nav-horizontal">
        ...
        <NavLink to="/database/worldmap" className={({ isActive }) => isActive ? 'active' : ''}>World Map</NavLink>
        <NavLink to="/database/missions" className={({ isActive }) => isActive ? 'active' : ''}>Missions</NavLink>
        <NavLink to="/database/worldpedia" className={({ isActive }) => isActive ? 'active' : ''}>Worldpedia</NavLink>
